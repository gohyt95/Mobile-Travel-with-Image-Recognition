...
class BookmarkAdapter(private val cellClickListener: CellClickListener): RecyclerView.Adapter<BookmarkAdapter.ViewHolder>() {

    var bookmarkList = listOf<Place>()
        set(value){
            field = value
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.bookmark_recyclerview_cell,parent,false)
